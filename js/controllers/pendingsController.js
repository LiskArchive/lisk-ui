...
angular.module('liskApp').controller('pendingsController', ['$scope', '$rootScope', '$http', 'viewFactory', 'contactsService', 'ngTableParams', 'gettextCatalog', function ($rootScope, $scope, $http, viewFactory, contactsService, ngTableParams, gettextCatalog) {
