...
angular.module('liskApp').controller('addContactModalController', ["$scope", "addContactModal", "$http", "userService", "contactsService", "viewFactory", "$timeout", 'gettextCatalog', function ($scope, addContactModal, $http, userService, contactsService, viewFactory, $timeout, gettextCatalog) {
